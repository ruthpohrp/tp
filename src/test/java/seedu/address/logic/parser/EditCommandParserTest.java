...
public class EditCommandParserTest {
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withDate(VALID_DATE_BOB)
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withDate(VALID_DATE_BOB).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
        ...
        userInput = targetIndex.getOneBased() + EMAIL_DESC_BOB + INVALID_DATE_DESC + ADDRESS_DESC_BOB
                + DATE_DESC_BOB;
        descriptor = new EditPersonDescriptorBuilder().withDate(VALID_DATE_BOB).withEmail(VALID_EMAIL_BOB)
