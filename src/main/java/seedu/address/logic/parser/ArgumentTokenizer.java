...
public class ArgumentTokenizer {
     ...
     *
     * @param argsString Arguments string of the form: {@code preamble <prefix>time <prefix>time ...}
     ...
     * The end position of the time is determined by {@code nextPrefixPosition}.
     */
