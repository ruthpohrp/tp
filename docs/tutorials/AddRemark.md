...
Simply add the following to [`seedu.address.ui.EventCard`](https://github.com/se-edu/addressbook-level3/commit/850b78879582f38accb05dd20c245963c65ea599#diff-0c6b6abcfac8c205e075294f25e851fe).
...
//...
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        Person editedPerson = new Person(
                personToEdit.getName(), personToEdit.getDate(), personToEdit.getEmail(),
